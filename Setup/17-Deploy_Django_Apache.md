...
```sh
    ...
    Example:- scp -P 22 <project_name>.zip <USERNAME>@216.32.44.12:
```
- Copied Successfully
...
```sh
    ...
    Example:- ssh -p 22 <USERNAME>@216.32.44.12
```
